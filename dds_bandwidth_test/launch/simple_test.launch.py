...
def generate_launch_description():
    ...
    # Simple subscriber node (for string messages only)
    subscriber_node = Node(
        package='dds_bandwidth_test',
        executable='simple_bandwidth_subscriber',
        name='simple_bandwidth_subscriber',
        parameters=[{
            'topic_name': LaunchConfiguration('topic_name'),
            'window_size': 1000,
            'report_interval': 5.0,
    ...
    log_info = LogInfo(msg=[
        'Starting simple bandwidth test with: ',
